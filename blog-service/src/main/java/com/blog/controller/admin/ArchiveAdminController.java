...
@ApiOperation(value = "archive", name = "归档管理模块", description = "归档管理接口", open = false)
public class ArchiveAdminController {
    @Autowired
    private ArchiveService archiveService;

    @GetMapping("/list")
    @ApiOperation(value = "list", name = "查询归档列表", type = ApiOperationType.QUERY, description = "查询所有归档")
    ...
    @ApiOperation(value = "regenerate", name = "重新生成归档", type = ApiOperationType.OTHER, description = "重新生成文章归档")
