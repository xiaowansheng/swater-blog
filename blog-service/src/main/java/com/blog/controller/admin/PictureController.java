...
@ApiOperation(value = "picture", name = "图片管理模块", description = "图片管理接口", open = false)
public class PictureController {
    @Autowired
    private PictureService pictureService;

    @GetMapping("/list")
    @ApiOperation(value = "list", name = "查询图片列表", type = ApiOperationType.QUERY, description = "分页查询图片列表")
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "detail", name = "获取图片详情", type = ApiOperationType.QUERY, description = "根据ID获取图片详情")
    ...
    @PostMapping
    @ApiOperation(value = "create", name = "创建图片", type = ApiOperationType.CREATE, description = "创建新图片")
    ...
    @PutMapping("/{id}")
    @ApiOperation(value = "update", name = "更新图片", type = ApiOperationType.UPDATE, description = "更新图片信息")
    ...
    @DeleteMapping("/{id}")
    @ApiOperation(value = "admin:picture:delete", name = "删除图片", type = ApiOperationType.DELETE, description = "删除图片")
    ...
    @PostMapping("/{id}/move")
    @ApiOperation(value = "move", name = "移动图片", type = ApiOperationType.UPDATE, description = "移动图片到指定相册")
