...
@ApiOperation(value = "config", name = "配置管理模块", description = "配置管理接口", open = false)
public class ConfigController {
    @Autowired
    private ConfigService configService;

    @GetMapping("/list")
    @ApiOperation(value = "list", name = "查询配置列表", type = ApiOperationType.QUERY, description = "按组查询配置列表")
    ...
    @GetMapping("/groups")
    @ApiOperation(value = "getGroups", name = "获取配置组", type = ApiOperationType.QUERY, description = "获取所有配置组")
    ...
    @GetMapping("/{key}")
    @ApiOperation(value = "detail", name = "获取配置详情", type = ApiOperationType.QUERY, description = "根据key获取配置")
    ...
    @PutMapping("/{key}")
    @ApiOperation(value = "update", name = "更新配置", type = ApiOperationType.UPDATE, description = "根据key更新配置")
    ...
    @PutMapping("/batch")
    @ApiOperation(value = "updateBatch", name = "批量更新配置", type = ApiOperationType.UPDATE, description = "批量更新配置")
