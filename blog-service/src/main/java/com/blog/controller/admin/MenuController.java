...
@ApiOperation(value = "menu", name = "菜单管理模块", description = "菜单管理接口", open = false)
public class MenuController {
    @Autowired
    private MenuService menuService;

    @GetMapping("/list")
    @ApiOperation(value = "list", name = "查询菜单列表", type = ApiOperationType.QUERY, description = "查询所有菜单")
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "detail", name = "获取菜单详情", type = ApiOperationType.QUERY, description = "根据ID获取菜单详情")
    ...
    @PostMapping
    @ApiOperation(value = "create", name = "创建菜单", type = ApiOperationType.CREATE, description = "创建新菜单")
    ...
    @PutMapping("/{id}")
    @ApiOperation(value = "update", name = "更新菜单", type = ApiOperationType.UPDATE, description = "更新菜单信息")
    ...
    @DeleteMapping("/{id}")
    @ApiOperation(value = "admin:menu:delete", name = "删除菜单", type = ApiOperationType.DELETE, description = "删除菜单")
    ...
    @ApiOperation(value = "assignMenus", name = "分配菜单", type = ApiOperationType.UPDATE, description = "为角色分配菜单")
