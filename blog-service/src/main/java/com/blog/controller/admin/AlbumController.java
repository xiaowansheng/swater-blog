...
@ApiOperation(value = "album", name = "相册管理模块", description = "相册管理接口", open = false)
public class AlbumController {
    @Autowired
    private AlbumService albumService;

    @GetMapping("/list")
    @ApiOperation(value = "list", name = "查询相册列表", type = ApiOperationType.QUERY, description = "分页查询相册列表")
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "detail", name = "获取相册详情", type = ApiOperationType.QUERY, description = "根据ID获取相册详情")
    ...
    @PostMapping
    @ApiOperation(value = "create", name = "创建相册", type = ApiOperationType.CREATE, description = "创建新相册")
    ...
    @PutMapping("/{id}")
    @ApiOperation(value = "update", name = "更新相册", type = ApiOperationType.UPDATE, description = "更新相册信息")
    ...
    @DeleteMapping("/{id}")
    @ApiOperation(value = "admin:album:delete", name = "删除相册", type = ApiOperationType.DELETE, description = "删除相册")
