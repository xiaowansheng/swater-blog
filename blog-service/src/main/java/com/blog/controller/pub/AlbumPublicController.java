...
@ApiOperation(value = "pub:album", name = "相册公开接口", description = "相册相关接口", open = true)
public class AlbumPublicController {
    @Autowired
    private AlbumPublicQueryService albumPublicQueryService;

    @GetMapping("/list")
    @ApiOperation(value = "query", name = "获取相册列表", type = ApiOperationType.QUERY, description = "分页获取相册列表")
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "query", name = "获取相册详情", type = ApiOperationType.QUERY, description = "根据ID获取相册详情")
