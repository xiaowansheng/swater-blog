...
@ApiOperation(value = "pub:archive", name = "归档公开接口", description = "文章归档相关接口", open = true)
public class ArchiveController {
    @Autowired
    private ArchiveService archiveService;

    @GetMapping("/list")
    @ApiOperation(value = "query", name = "获取归档列表", type = ApiOperationType.QUERY, description = "获取文章归档时间线列表")
    ...
    @ApiOperation(value = "query", name = "获取归档文章列表", type = ApiOperationType.QUERY, description = "根据年份和月份获取文章列表")
