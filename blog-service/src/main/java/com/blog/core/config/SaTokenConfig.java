...
import com.blog.core.interceptor.ApiPermissionInterceptor;
                    ...
                    .check(r -> {
                        ...
                        try {
                            ...
                            if (user == null || user.getDeleted() == 1) {
                                ...
                                StpUtil.logout();
                                throw new com.blog.common.exception.BusinessException("用户不存在");
                            }

                            if (user.getStatus() != null && user.getStatus() == 0) {
                                log.warn("用户已被禁用: userId={}", userId);
                                StpUtil.logout();
                                throw new com.blog.common.exception.BusinessException("用户已被禁用");
                            }
