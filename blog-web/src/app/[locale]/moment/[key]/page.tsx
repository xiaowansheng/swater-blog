    ...
    <>
      ...
      <main className="container mx-auto px-4 py-12 flex-1">
        <article className="group relative bg-card border border-border rounded-2xl p-8 md:p-12 shadow-sm max-w-4xl mx-auto">
          ...
          <div className="absolute bottom-12 right-12 text-primary/20 text-sm animate-twinkle pointer-events-none" style={{ animationDelay: '0.5s' }}>
            ✧
          </div>
          <div className="absolute top-1/2 left-6 text-accent/10 text-xs animate-twinkle pointer-events-none" style={{ animationDelay: '1s' }}>
            ✦
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="relative rounded-xl p-6 bg-gradient-to-br from-secondary/20 to-transparent border border-primary/5 mb-6">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: sanitizeHtmlServer(moment.content) }}
              />
            </div>
            ...
            <div className="mb-8">
              <ContentLikeButton contentType="TALK" contentId={moment.id} initialLikeCount={moment.likeCount || 0} />
            </div>
