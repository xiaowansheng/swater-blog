                  ...
                  <div className="px-5 py-4 border-b border-primary/10">
                    ...
                    <div className="flex gap-3 mb-3">
                      ...
                      <button
                        ...
                        className="flex-1 min-h-[50px] flex flex-col items-center justify-center gap-0.5 px-3 rounded-xl bg-gradient-to-br from-accent/5 to-primary/5 hover:from-accent/10 hover:to-primary/10 active:from-accent/15 active:to-primary/15 transition-all border border-accent/10 hover:border-accent/20 text-xs font-medium text-foreground/80"
                      >
                    ...
                    <button
                      ...
                      className="w-full min-h-[50px] flex items-center justify-center gap-2 px-4 rounded-xl bg-gradient-to-br from-primary/5 to-accent/5 hover:from-primary/10 hover:to-accent/10 active:from-primary/15 active:to-accent/15 transition-all border border-primary/10 hover:border-primary/20 text-sm font-medium text-foreground/80 hover:text-primary"
                    >
