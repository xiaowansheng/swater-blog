    ...
    <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      <div className="relative">
        <Card className="p-5 sm:p-6" hoverEffect={false}>
          <div className="mb-5 flex items-center gap-3">
            ...
            <span className="rounded-full border border-primary/15 bg-primary/5 px-3 py-1 text-xs text-primary/70">
      ...
      <div className="relative">
        <div className="sticky top-20">
          <Card className="p-6 relative overflow-hidden bg-gradient-to-br from-card via-secondary/30 to-primary/10" variant="glass" hoverEffect={false}>
