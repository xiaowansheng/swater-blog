                              ...
                              <div className="relative z-10 flex flex-col gap-3">
                                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
                                  <Link
                                    ...
                                    className="text-lg font-bold text-foreground/90 hover:text-primary transition-colors line-clamp-2 flex items-center gap-2"
                                  >
                                    {article.hasPassword && (
                                      <svg className="w-4 h-4 text-primary/70 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Encrypted">
